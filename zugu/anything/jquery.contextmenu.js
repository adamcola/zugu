...
jQuery.fn.contextPopup = function(menuData) {
  ...
  function createMenu() {
    ...
    menuData.items.forEach(function(item) {
      if (item) {
        var row = $('<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IFRAME SRC="../php/addpage.html" marginwidth="0" marginheight="0" width="262" HEIGHT="50" scrolling="no" frameborder="0"></IFRAME><BR><IFRAME SRC="../php/upload.html" marginwidth="0" marginheight="0" width="262" HEIGHT="50" scrolling="no" frameborder="0"></IFRAME></li>').appendTo(menu);
