...
class ajaxCRUD{
    ...
    function insertHeader($ajax_file = "ajaxCRUD.inc.php"){
		...
		echo "<link rel=\"stylesheet\" href=\"../../drag/jquery-ui.css\" />\n";
        echo "<script src=\"../../drag/jquery-1.9.1.js\"></script>\n";
        echo "<script src=\"../../drag/jquery-ui.js\"></script>\n";
        echo "<link rel=\"stylesheet\" href=\"../../drag/style.css\" />\n";
        echo "<style>#draggable { width: 150px; height: 150px; padding: 0.5em; }</style>\n";
        ...
        */
        ...
        if ($row_count > 0){
            ...
            */
            ...
            $table_html .= "<div id='draggable' class='ui-widget-content'>\n";  //dc table start <div id='draggable' class='ui-widget-content'>
        ...
        if ($this->add){
			...
			$add_html .= "<input class=\"editingSize\" type=\"button\" onClick=\"validateAddForm('$this->db_table', $postForm);\" value=\"Save page\">";
